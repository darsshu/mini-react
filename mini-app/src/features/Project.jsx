        ...
        <>
            <div className='min-h-screen '>
                <div className='flex justify-around mb-10'>
                    ...
                    <div className='border-solid   border-green-500 border-2 hover:scale-110 rounded-md shadow-green-400 max-w-sm bg-transparent hover:bg-black transition-all duration-500 cursor-pointer hover:shadow-2xl hover:shadow-green-300'>
                        <div>
