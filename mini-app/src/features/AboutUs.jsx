            ...
            <div className='' id='aboutus'>
                <div className=' flex justify-between  items-center h-screen ' >
                    ...
                    <div className=' w-2/4 items-center  me-28'>
                        ...
                        <p className='font-sans  text-2xl text-start mt-2 text-orange-400'>I am from Ahemdabad .My Education is B-Tech Computer Engineering from Gandhinagar Institute of Technology .
