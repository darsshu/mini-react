        ...
        <>
            <div className='h-screen '>
                <form action="" onSubmit={datasubmit} >
                    ...
                    <div className='text-center mb-3 '>
                        <input id="phone" className='h-12 text-center bg-transparent text-2xl border-solid font-mono text-green-500 border-green-400 rounded-lg border-2 w-1/2' type="tel" autoComplete='off' min={10} max={10} placeholder='Mo-Number' required />
                    </div>
                    <div className='text-center mb-3 '>
